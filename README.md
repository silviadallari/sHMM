...
The implementation follows the methodology described in *A Scalable and Interpretable Supervised Hidden Markov Model for Tractor Operational State Prediction* and includes the core estimation and prediction routines for the supervised model.
